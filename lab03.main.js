 ...
 * @return {string} (firstIpAddress) - An IPv4 address and IPv6
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    respuestaIPv6 = getIpv4MappedIpv6Address(firstIpAddress);
  }
  ...
  return callback({ipv4: firstIpAddress, ipv6: respuestaIPv6}, callbackError);
}
/*
